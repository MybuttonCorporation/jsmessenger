module.exports = {
    ...
    async run(args = []) {
        ...
        axios.get("https://jsmsgserver.nehirkedi.repl.co" + path).then(async response => {
            console.log(chalk.bold.yellow('Connecting to ' + chalk.bold.bgBlack.magenta(path)));
            ...
            console.log(chalk.bold.yellow('A Socket has been created at ' + chalk.bold.bgBlack.magenta(path)));
        }).catch(e => {
